    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <!--
            $v gives us acces to the validators.
            $touch vem do vuelidate.
          -->
          <input
            type="email"
            id="email"
...
<script>
  ...
  // instância do axios do arquivo main.js
  ...
  export default {
    ...
    validations: {
      email: {
        ...
        /*
        simulando uma chamada async.
        Digite test@test.com no email, a validação vai ocorrer em 2 segundos
        */
        // unique: val => {
        ...
        /*
        chamando o serviço do firebase
        */
        unique: val => {
      ...
      hobbyInputs: {
        ...
        minLen: minLength(2),
        $each: {
          // // value é o model do input hobby
          value: {
            required,
            minLen: minLength(5)
          }
